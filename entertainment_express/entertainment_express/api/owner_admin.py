...
PERMITTED_MASTER_DOCTYPES = {
    ...
    "Customer": {"label": "Customers", "module": "Selling", "description": "Client directory, accounts, and contact billing profiles."},
    "EE Venue": {"label": "Venues & Locations", "module": "Venues Vendors", "description": "Halls, parks, and venues with load-in and power specifications."},
    "EE Vendor": {"label": "Partners & Subcontractors", "module": "Venues Vendors", "description": "External talent, rental partners, and production vendors."},
    "Item": {"label": "Catalog Packages & Items", "module": "Stock", "description": "Sellable packages, services, and rental equipment items."},
    "Service Asset": {"label": "Service Assets", "module": "Equipment Fleet", "description": "Serialized gear, trucks, photo booths, and inflatables inventory."},
    "Service Area": {"label": "Service Areas", "module": "Logistics", "description": "Delivery radiuses, travel fee zones, and service coverage."},
