    ...
    catalogs = {
        ...
        "job": {
            ...
            "fields": [
                ...
                {"key": "delivery_window_start", "label": "Delivery window start", "type": "datetime"},
                {"key": "delivery_window_end", "label": "Delivery window end", "type": "datetime"},
                {"key": "pickup_window_start", "label": "Pickup window start", "type": "datetime"},
                {"key": "pickup_window_end", "label": "Pickup window end", "type": "datetime"},
                {
                    "key": "status",
                    "label": "Status",
                    "type": "select",
...
def _save_job(name: str | None, values: dict) -> str:
    ...
    payload = {
        ...
        "delivery_window_start": values.get("delivery_window_start") or None,
        "delivery_window_end": values.get("delivery_window_end") or None,
        "pickup_window_start": values.get("pickup_window_start") or None,
        "pickup_window_end": values.get("pickup_window_end") or None,
