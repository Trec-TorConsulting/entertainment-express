...
website_route_rules = [
    ...
    {"from_route": "/compare/inflatable-office", "to_route": "compare?competitor=inflatable-office"},
    {"from_route": "/compare/goodshuffle-pro", "to_route": "compare?competitor=goodshuffle-pro"},
    {"from_route": "/compare/dj-event-planner", "to_route": "compare?competitor=dj-event-planner"},
    {"from_route": "/compare/honeybook", "to_route": "compare?competitor=honeybook"},
    {"from_route": "/compare/event-rental-systems", "to_route": "compare?competitor=event-rental-systems"},
    {"from_route": "/compare/<path:competitor>", "to_route": "compare"},
    {"from_route": "/features/weather-risk", "to_route": "feature_page?feature=weather-risk"},
    {"from_route": "/features/dispatch-load-planning", "to_route": "feature_page?feature=dispatch-load-planning"},
    {"from_route": "/features/dj-playlist-export", "to_route": "feature_page?feature=dj-playlist-export"},
    {"from_route": "/features/customer-portal", "to_route": "feature_page?feature=customer-portal"},
    {"from_route": "/features/white-label-branding", "to_route": "feature_page?feature=white-label-branding"},
    {"from_route": "/features/ai-copilot", "to_route": "feature_page?feature=ai-copilot"},
