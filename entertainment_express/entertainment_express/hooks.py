...
scheduler_events = {
    ...
    "hourly": [
        ...
        "entertainment_express.api.saas_billing.handle_trial_expirations",
    ...
    "daily": [
        ...
        "entertainment_express.job_costing.settlement.auto_settle_completed_bookings",
...
website_route_rules = [
    ...
    {"from_route": "/customer", "to_route": "client"},
    {"from_route": "/customer/<path:app_path>", "to_route": "client"},
    {"from_route": "/dispatch", "to_route": "employee"},
    {"from_route": "/dispatch/<path:app_path>", "to_route": "employee"},
    {"from_route": "/crew", "to_route": "employee"},
    {"from_route": "/crew/<path:app_path>", "to_route": "employee"},
    {"from_route": "/solutions/djs", "to_route": "solutions", "defaults": {"vertical": "djs"}},
    {"from_route": "/solutions/rentals", "to_route": "solutions", "defaults": {"vertical": "rentals"}},
    {"from_route": "/solutions/photo-booths", "to_route": "solutions", "defaults": {"vertical": "photo-booths"}},
    {"from_route": "/solutions/game-trucks", "to_route": "solutions", "defaults": {"vertical": "game-trucks"}},
    {"from_route": "/solutions/casino", "to_route": "solutions", "defaults": {"vertical": "casino"}},
    {"from_route": "/solutions/performers", "to_route": "solutions", "defaults": {"vertical": "performers"}},
    {"from_route": "/solutions/<path:vertical>", "to_route": "solutions"},
    {"from_route": "/for/<path:vertical>", "to_route": "solutions"},
    {"from_route": "/compare/inflatable-office", "to_route": "compare", "defaults": {"competitor": "inflatable-office"}},
    {"from_route": "/compare/goodshuffle-pro", "to_route": "compare", "defaults": {"competitor": "goodshuffle-pro"}},
    {"from_route": "/compare/dj-event-planner", "to_route": "compare", "defaults": {"competitor": "dj-event-planner"}},
    {"from_route": "/compare/honeybook", "to_route": "compare", "defaults": {"competitor": "honeybook"}},
    {"from_route": "/compare/event-rental-systems", "to_route": "compare", "defaults": {"competitor": "event-rental-systems"}},
    {"from_route": "/compare/<path:competitor>", "to_route": "compare"},
    {"from_route": "/vs/<path:competitor>", "to_route": "compare"},
    {"from_route": "/features/weather-risk", "to_route": "feature_page", "defaults": {"feature": "weather-risk"}},
    {"from_route": "/features/dispatch-load-planning", "to_route": "feature_page", "defaults": {"feature": "dispatch-load-planning"}},
    {"from_route": "/features/dj-playlist-export", "to_route": "feature_page", "defaults": {"feature": "dj-playlist-export"}},
    {"from_route": "/features/customer-portal", "to_route": "feature_page", "defaults": {"feature": "customer-portal"}},
    {"from_route": "/features/white-label-branding", "to_route": "feature_page", "defaults": {"feature": "white-label-branding"}},
    {"from_route": "/features/ai-copilot", "to_route": "feature_page", "defaults": {"feature": "ai-copilot"}},
