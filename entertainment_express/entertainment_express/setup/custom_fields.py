...
CUSTOM_FIELDS = {
    ...
    "Item": [
        ...
        {
            "dt": "Item",
            "fieldname": "ee_weather_sensitive",
            "fieldtype": "Check",
            "label": "Weather Sensitive",
            "insert_after": "ee_event_types",
            "default": "0",
            "description": "Outdoor / weather-sensitive service — forecast checks apply when booked",
        },
        {
            "dt": "Item",
            "fieldname": "ee_wind_mph_max",
            "fieldtype": "Float",
            "label": "Wind Override (mph)",
            "insert_after": "ee_weather_sensitive",
            "depends_on": "eval:doc.ee_weather_sensitive",
            "description": "Optional override of tenant Weather Policy max wind",
        },
        {
            "dt": "Item",
            "fieldname": "ee_precip_inch_hours",
            "fieldtype": "Float",
            "label": "Precip Override (in)",
            "insert_after": "ee_wind_mph_max",
            "depends_on": "eval:doc.ee_weather_sensitive",
            "description": "Optional override of tenant Weather Policy max precip",
        },
        {
            "dt": "Item",
            "fieldname": "ee_packed_weight_lbs",
            "fieldtype": "Float",
            "label": "Packed Weight (lbs)",
            "insert_after": "ee_precip_inch_hours",
        },
        {
            "dt": "Item",
            "fieldname": "ee_packed_length_in",
            "fieldtype": "Float",
            "label": "Packed Length (in)",
            "insert_after": "ee_packed_weight_lbs",
        },
        {
            "dt": "Item",
            "fieldname": "ee_packed_width_in",
            "fieldtype": "Float",
            "label": "Packed Width (in)",
            "insert_after": "ee_packed_length_in",
        },
        {
            "dt": "Item",
            "fieldname": "ee_packed_height_in",
            "fieldtype": "Float",
            "label": "Packed Height (in)",
            "insert_after": "ee_packed_width_in",
        },
        {
            "dt": "Item",
            "fieldname": "ee_amperage_draw",
            "fieldtype": "Float",
            "label": "Electrical Amperage Draw",
            "insert_after": "ee_packed_height_in",
        },
        {
            "dt": "Item",
            "fieldname": "ee_fulfillment_mode",
            "fieldtype": "Select",
            "label": "Fulfillment Mode",
            "options": "\nattended\ndrop_off\nself_serve",
            "default": "attended",
            "insert_after": "ee_precip_inch_hours",
            "description": "attended requires crew; drop_off may skip attendant; self_serve is client-operated",
        },
        {
            "dt": "Item",
            "fieldname": "ee_site_fit_requirements",
            "fieldtype": "Table",
            "label": "Site Fit Requirements",
            "options": "EE Site Fit Requirement",
            "insert_after": "ee_fulfillment_mode",
        },
        {
            "dt": "Item",
            "fieldname": "ee_includes_media_gallery",
            "fieldtype": "Check",
            "label": "Includes Media Gallery",
            "insert_after": "ee_site_fit_requirements",
            "default": "0",
            "description": "Booth/media package — create a gallery for bookings of this item",
        },
        {
            "dt": "Item",
            "fieldname": "ee_brand",
            ...
            "label": "Brand",
            "options": "EE Brand",
            "insert_after": "ee_includes_media_gallery",
            "description": "Multi-brand catalog filter; blank = all / default brand",
        },
    ],
    ...
    "Quotation": [
        ...
        },
        {
            ...
            "fieldtype": "Data",
            "label": "PO Number",
            "insert_after": "ee_last_viewed_at",
        },
        {
            "dt": "Quotation",
            "fieldname": "ee_brand",
    ...
    "Sales Invoice": [
        ...
        },
        {
            ...
            "fieldtype": "Data",
            "label": "PO Number",
            "insert_after": "ee_accounting_id",
        },
        {
            "dt": "Sales Invoice",
            "fieldname": "ee_late_fee_for",
            "fieldtype": "Link",
            "label": "Late Fee For Invoice",
        ...
        {
            "dt": "Sales Invoice",
            "fieldname": "ee_late_fee_applied",
            "fieldtype": "Check",
            "label": "Late Fee Applied",
            "default": "0",
            "insert_after": "ee_late_fee_for",
            "read_only": 1,
        },
        {
            "dt": "Sales Invoice",
            ...
            "label": "Brand",
            "options": "EE Brand",
            "insert_after": "ee_late_fee_applied",
        },
    ],
    "Opportunity": [
        {
    ...
    "Customer": [
        ...
        {
            "dt": "Customer",
            "fieldname": "ee_payment_terms",
            "fieldtype": "Select",
            "label": "EE Payment Terms",
            "options": "net_0\nnet_15\nnet_30",
            "default": "net_0",
            "insert_after": "ee_lead",
        },
    ],
    "Lead": [
        {
