...
def get_context(context):
    ...
    apply_common_page_context(
        ...
        "Explore offline PWA sync, event copilot, B2B exchange, instant payouts, live flight deck, mobile Stripe POS, Company Studio, AI financial intelligence, and predictive margin guardrails.",
        "/features",
