...
COMPETITORS = {
    "inflatable-office": {
        ...
        "comparison_features": [
            ...
            {"feature": "PWA Stripe Terminal POS Hardware", "ee": "Yes — Native Bluetooth", "competitor": "No"},
            {"feature": "Weather Risk Automation (Wind/Rain/Lightning)", "ee": "Yes", "competitor": "No"},
            {"feature": "Computer Vision Smart Van Eye", "ee": "Yes — Damage Quarantine", "competitor": "No"},
            {"feature": "Mobile Crew App (PWA & Offline)", "ee": "Yes", "competitor": "No"},
            {"feature": "Autonomous AR Dunning & Quoting", "ee": "Yes — Pro & Scale", "competitor": "No"},
            {"feature": "24/7 AI Voice Phone Receptionist", "ee": "Yes — Twilio Voice AI", "competitor": "No"},
            ...
            {"feature": "Smart Operations Assistant", "ee": "Scale plan", "competitor": "No"},
        ],
    ...
    "goodshuffle-pro": {
        ...
        "comparison_features": [
            ...
            {"feature": "Company Studio & Full Owner Parity", "ee": "Yes — No Backend Needed", "competitor": "Basic settings"},
            {"feature": "Autonomous AR Dunning & Receipts", "ee": "Yes — Multimodal OCR", "competitor": "No"},
            {"feature": "Autonomous Emergency Dispatch Copilot", "ee": "Yes — Shift Broadcasts", "competitor": "No"},
    ...
    "dj-event-planner": {
        ...
        "comparison_features": [
            ...
            {"feature": "PWA Stripe Terminal POS Hardware", "ee": "Yes — Chip & Tap on Phones", "competitor": "No"},
            {"feature": "1-Click Serato/Rekordbox Playlist Export", "ee": "Yes", "competitor": "No"},
            {"feature": "60-Second Instant Lead Quoting AI", "ee": "Yes — Instant Estimates", "competitor": "No"},
            {"feature": "Autonomous AR Dunning & Reminders", "ee": "Yes — 1-Click Pay Links", "competitor": "Manual email"},
            {"feature": "24/7 AI Voice Phone Receptionist", "ee": "Yes — Twilio Voice AI", "competitor": "No"},
    ...
    "honeybook": {
        ...
        "comparison_features": [
            ...
            {"feature": "PWA Stripe Terminal POS Hardware", "ee": "Yes — Native Bluetooth", "competitor": "No"},
            {"feature": "Computer Vision Smart Van Eye", "ee": "Yes — Van Inspection", "competitor": "No"},
            {"feature": "Multi-Crew Dispatch & Run Sheets", "ee": "Yes", "competitor": "No"},
            {"feature": "Autonomous AR Dunning & Pay Links", "ee": "Yes — Multi-channel", "competitor": "Basic auto-charge"},
            {"feature": "Autonomous Emergency Dispatch Copilot", "ee": "Yes — 1-Click Replacements", "competitor": "No"},
    ...
    "event-rental-systems": {
        ...
        "comparison_features": [
            ...
            {"feature": "PWA Stripe Terminal POS Hardware", "ee": "Yes — Chip & Tap on Phones", "competitor": "No"},
            {"feature": "Computer Vision Smart Van Eye", "ee": "Yes — AI Gear Verification", "competitor": "No"},
            {"feature": "Automated Weather Cancellation Risk", "ee": "Yes", "competitor": "No"},
            {"feature": "Autonomous AR Dunning & 60s Quoting", "ee": "Yes — Pro & Scale", "competitor": "No"},
            {"feature": "24/7 AI Voice Phone Receptionist", "ee": "Yes — Twilio Voice AI", "competitor": "No"},
