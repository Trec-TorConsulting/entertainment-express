...
FEATURES = {
    ...
    "ai-copilot": {
        "name": "Smart Operations & Platform Copilot",
        "headline": "Save Hours with AI Platform Guidance & Context-Aware Actions",
        "summary": "Full platform knowledge covering Company Studio, Tax Rules, Dispatch, Field PWA, and Subcontractor Exchange with 1-click route navigation.",
        "meta_description": "AI operations copilot with deep platform knowledge. Get instant answers on accounting, dispatch, field sync, subcontractor job board, and jump directly to relevant owner routes.",
        "problem": "Event operators lose hours navigating menus or looking up how to set tax rules, configure PWA card readers, manage subcontractor payouts, or check gross margin guardrails.",
        "solution": "Built straight into your daily workflow, our AI Copilot possesses complete context-aware platform knowledge across all 12 ERP modules. Ask questions in plain English about accounting, dispatch, B2B exchange, or weather alerts, and receive instant answers alongside 1-click route buttons taking you straight to the relevant owner page.",
        "highlights": [
            "Complete ERP Platform Knowledge: Expert answers across Company Studio, tax rules, PWA POS, margin guardrails, and dispatch",
            "Context-Aware Action Buttons: Instant route navigation links (e.g., jump directly to /owner/subcontractors or /owner/plan)",
        ...
        "keywords": ["event management assistant", "AI platform copilot", "event business automation", "event booking workflow", "automated quoting event software"],
        "icon": "⚡",
    },
    "pwa-stripe-pos": {
    ...
    "b2b-overflow-exchange": {
        "name": "Subcontractor Management & B2B Overflow Exchange",
        "headline": "Monetize Overbooked Dates & Cross-Rent Rigs Securely with Subcontractor Partners",
        "summary": "Subcontractor partner onboarding, opt-in B2B blast notifications, central overflow job board, COI verification, and margin escrow.",
        "meta_description": "Subcontractor partner management and B2B overflow job exchange for event companies. Subcontractor directory, opt-in job blast notifications, and escrow settlement.",
        "problem": "Operators lose revenue when turning away overbooked dates or lacking specialized equipment, while fearing client poaching when farming out gigs to unvetted subcontractors.",
        "solution": "Manage trusted subcontractor partners with custom payouts and COI tracking, or opt into the B2B Overflow Exchange network. Owners receive broadcast blast alerts for available gigs, post overflow jobs with budget controls, and settle payouts automatically upon verified job completion.",
        "highlights": [
            "Subcontractor Partner Directory: Add & manage sub partners with custom pay rates and COI expiration tracking",
            "Opt-In B2B Blast Notifications: Opt in with one click to receive instant SMS/email alerts for local overflow jobs",
            "Central Overflow Job Board: Browse available gigs, view estimated payout, and claim jobs with 1-click owner approval",
            "Control Plane Clearinghouse: Cross-tenant job matching preserving strict multi-tenant database isolation",
            "Automated COI & Margin Escrow: Mutual sign-off releases payout directly to fulfilling partner upon event completion",
        ],
        "keywords": ["subcontractor management event", "B2B event exchange", "party rental gear subrental", "event overflow job board", "coi verification event"],
        "icon": "🤝",
    },
    "owner-onboarding-launchpad": {
        "name": "Gamified Owner Launchpad & Setup Checklist",
        "headline": "Go Live in Minutes with Interactive Step-by-Step Onboarding",
        "summary": "Gamified progress widget, interactive setup milestones, instant route shortcuts, and Frappe Onboarding integration.",
        "meta_description": "Gamified owner onboarding launchpad for event companies. Step-by-step setup progress, instant route shortcuts, and Frappe Onboarding integration.",
        "problem": "New software onboarding is often overwhelming, forcing business owners to dig through complex menus to configure tax rules, connect Stripe, and set up staff accounts.",
        "solution": "The Owner Launchpad widget sits directly on your /owner homepage. It guides you through essential setup milestones—from company profile and Stripe connection to adding subcontractors and creating your first booking—with progress percentages and 1-click route jumps.",
        "highlights": [
            "Gamified Setup Progress Bar: Live percentage tracking of completed onboarding milestones",
            "1-Click Action Jump Links: Direct navigation to Company Studio, Subcontractors, Stripe Setup, and Calendar",
            "Frappe Onboarding Integration: Built-in system setup state sync ensuring nothing is missed",
            "Dismissable & Resumeable: Easily hide when setup is complete or expand anytime from settings",
        ],
        "keywords": ["event software onboarding", "owner launchpad checklist", "frappe onboarding", "event business setup"],
        "icon": "🎯",
    },
