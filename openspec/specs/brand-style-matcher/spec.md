# Capability: Brand Style Matcher

## Purpose
Import brand look-and-feel from a public company website URL and/or logo upload into white-label
settings, with preview and one-click apply — without storing scraped HTML.
