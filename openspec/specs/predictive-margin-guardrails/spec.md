# predictive-margin-guardrails Specification

## Purpose
Pre-quote direct cost simulation, minimum margin floor validation, real-time margin drift monitoring, and post-event ERPNext cost center locking and journal entry settlement.
