# Capability: logistics-bom-van-warehouses

## Purpose
Track hierarchical production kits, mobile Van-as-a-Warehouse inventories, barcode scan-to-truck loadout and return check-in reconciliation, and third-party equipment sub-rental procurement.
