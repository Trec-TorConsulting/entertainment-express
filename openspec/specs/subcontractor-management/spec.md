...
## Purpose
Manage external partner and subcontractor relationships, sub-out gig job workflows, white-label job packets, tokenized external offer accept/decline responses, and margin/payout tracking.
